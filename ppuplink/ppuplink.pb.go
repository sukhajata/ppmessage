...
type UplinkMessage struct {
	...
	Dr          int32  `protobuf:"varint,6,opt,name=dr,proto3" json:"dr,omitempty"`
	Fctn        uint64 `protobuf:"varint,7,opt,name=fctn,proto3" json:"fctn,omitempty"`
	Rawdata     string `protobuf:"bytes,8,opt,name=rawdata,proto3" json:"rawdata,omitempty"`
	Messageid   uint32 `protobuf:"varint,9,opt,name=messageid,proto3" json:"messageid,omitempty"`
	Messagetype uint32 `protobuf:"varint,10,opt,name=messagetype,proto3" json:"messagetype,omitempty"`
	Resent      uint32 `protobuf:"varint,11,opt,name=resent,proto3" json:"resent,omitempty"`
}
...
func (x *UplinkMessage) GetDr() int32 {
	if x != nil {
		return x.Dr
	}
	return 0
...
type MeterStatusMessage struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Deviceeui      string `protobuf:"bytes,1,opt,name=deviceeui,proto3" json:"deviceeui,omitempty"`
	Timesent       uint64 `protobuf:"varint,2,opt,name=timesent,proto3" json:"timesent,omitempty"`
	Modbusaddress  uint32 `protobuf:"varint,3,opt,name=modbusaddress,proto3" json:"modbusaddress,omitempty"`
	Digitalinputs  int32  `protobuf:"varint,4,opt,name=digitalinputs,proto3" json:"digitalinputs,omitempty"`
	Digitaloutputs int32  `protobuf:"varint,5,opt,name=digitaloutputs,proto3" json:"digitaloutputs,omitempty"`
	Alarmstate1    int32  `protobuf:"varint,6,opt,name=alarmstate1,proto3" json:"alarmstate1,omitempty"`
	Alarmstate2    int32  `protobuf:"varint,7,opt,name=alarmstate2,proto3" json:"alarmstate2,omitempty"`
	Commsstate1    int32  `protobuf:"varint,8,opt,name=commsstate1,proto3" json:"commsstate1,omitempty"`
	Commsstate2    int32  `protobuf:"varint,9,opt,name=commsstate2,proto3" json:"commsstate2,omitempty"`
	Spare1         int32  `protobuf:"varint,10,opt,name=spare1,proto3" json:"spare1,omitempty"`
}

func (x *MeterStatusMessage) Reset() {
	*x = MeterStatusMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ppuplink_proto_msgTypes[20]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *MeterStatusMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MeterStatusMessage) ProtoMessage() {}

func (x *MeterStatusMessage) ProtoReflect() protoreflect.Message {
	mi := &file_ppuplink_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MeterStatusMessage.ProtoReflect.Descriptor instead.
func (*MeterStatusMessage) Descriptor() ([]byte, []int) {
	return file_ppuplink_proto_rawDescGZIP(), []int{20}
}

func (x *MeterStatusMessage) GetDeviceeui() string {
	if x != nil {
		return x.Deviceeui
	}
	return ""
...
func (x *MeterStatusMessage) GetTimesent() uint64 {
	if x != nil {
		return x.Timesent
	}
	return 0
...
func (x *MeterStatusMessage) GetModbusaddress() uint32 {
	if x != nil {
...
func (x *MeterStatusMessage) GetDigitalinputs() int32 {
	if x != nil {
...
func (x *MeterStatusMessage) GetDigitaloutputs() int32 {
	if x != nil {
...
func (x *MeterStatusMessage) GetAlarmstate1() int32 {
	if x != nil {
		return x.Alarmstate1
	}
	return 0
}

func (x *MeterStatusMessage) GetAlarmstate2() int32 {
	if x != nil {
		return x.Alarmstate2
	}
	return 0
}

func (x *MeterStatusMessage) GetCommsstate1() int32 {
	if x != nil {
		return x.Commsstate1
	}
	return 0
}

func (x *MeterStatusMessage) GetCommsstate2() int32 {
	if x != nil {
		return x.Commsstate2
	}
	return 0
}

func (x *MeterStatusMessage) GetSpare1() int32 {
	if x != nil {
		return x.Spare1
	}
	return 0
...
var file_ppuplink_proto_rawDesc = []byte{
	...
	0x09, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x65, 0x75, 0x69, 0x12, 0x1a, 0x0a, 0x08, 0x74, 0x69,
	0x6d, 0x65, 0x73, 0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x74, 0x69,
	0x6d, 0x65, 0x73, 0x65, 0x6e, 0x74, 0x22, 0xa3, 0x02, 0x0a, 0x0d, 0x55, 0x70, 0x6c, 0x69, 0x6e,
	...
	,
	...
	,
	...
	0x70, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2f, 0x70, 0x70, 0x75, 0x70, 0x6c, 0x69, 0x6e,
...
var file_ppuplink_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_ppuplink_proto_goTypes = []interface{}{
	...
	(*MeterStatusMessage)(nil),     // 20: ppuplink.MeterStatusMessage
}
...
func file_ppuplink_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ppuplink_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MeterStatusMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
